...
- Drive job: [wrench-5060ti-hf-package-20260921-02.json](https://drive.google.com/file/d/1V0AcZ-EQ_lRDB-aaJYVwRNMxMVkpNFAW/view?usp=drivesdk)
...
and uploads a verified receipt. The manifest is now visibly present in
`jobs/pending`, but the worker has not consumed it yet.
