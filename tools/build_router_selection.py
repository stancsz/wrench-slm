...
def build_selection(profile_path: Path, output_path: Path, keep: int) -> dict[str, Any]:
...
def main() -> int:
    ...
    receipt = build_selection(args.profile.resolve(), args.output.resolve(), args.keep)
