...
def main() -> int:
    ...
    for path in [
        ...
        args.model_dir / "toolbelt.py",
        args.model_dir / "core.py",
        ...
        args.model_dir / "wrench_runtime" / "handoff.py",
        args.model_dir / "wrench_runtime" / "worker.py",
        args.model_dir / "wrench_runtime" / "intent_safety_gate.py",
        args.model_dir / "wrench_worker.py",
        args.model_dir / "run_claude_code.ps1",
        args.model_dir / "wrench_loopback_blocker.py",
