...
def materialize(
    ...
    try:
            ...
            json.dumps(
                {
                    ...
                    "fast_mode": {
                        ...
                        "context_gate": {
                            ...
                            "strategy": "mapreduce_dynamic_native",
                            "declared_raw_input_context_tokens": 4000000,
                            "raw_input_limit_enforced": True,
                            "over_limit_behavior": "HTTP_400_fail_closed",
                            "effective_working_context_tokens": 64000,
                            "hot_context_tokens": 48000,
                            "reference_card_tokens": 16000,
                            "hash_bound_lookup_evidence": True,
                        },
                    },
                    "native_mode": {
                        ...
                        "context_gate": {
                            "stage": "conditional_dense_native_first_layer",
                            "strategy": "pruner_cherrypicker_to_bounded_working_context",
                            "raw_input_context_tokens": 4000000,
                            "target_working_context_tokens": {
                                "min": 32000,
                                "max": 64000,
                            },
                            ...
                            "preserve": [
                                ...
                                "recent_tool_state",
                                "hash_bound_lookup_evidence",
                            ],
                            "status": "conditional_optional_not_release_blocking",
                        },
        ...
        shutil.copy2(repo_root / "packaging" / "run_claude_code.ps1", target / "run_claude_code.ps1")
        ...
        package_manifest = {
            ...
            "runtime": {
                ...
                "context_gate": {
                    ...
                    "over_limit_behavior": "HTTP_400_fail_closed",
                    "effective_working_context_tokens": 64000,
                    "dense_native_gate": "conditional_optional",
                },
