# Synthetic M3 context-token reduction protocol 03

Status: **frozen for one offline run**. Supersedes protocol 02, whose parser
stopped before tokenizer loading; no token counts or receipt were produced.
Earlier explicit-operation proxy protocols remain superseded and are not
execution authority.

Job ID: `W2-SYN-M3-CTX-REDUCTION-20260925-02`  
Nonce: `SYNCTX04-91A7`  
Runner: `tools/measure_synthetic_context_token_reduction.py`  
Runner SHA-256: `d2b3a4a78cd58e8bd7c69ea1a1e5d38331c8389ea1aa0f7d7fad3c64e3181e04`
Frozen one-shot output: `C:\wrench-slm-data\artifacts\wrench-local-acceptability\synthetic-context-m3-reduction-02.json`
...
- Use the already held reservation `W2-SYN-M3-CTX-REDUCTION-20260925-02` for
...
- Frozen command:
  ...
  ```powershell
  C:\wrench-slm-data\envs\wrench-local-synthetic-cp313\Scripts\python.exe tools\measure_synthetic_context_token_reduction.py --output C:\wrench-slm-data\artifacts\wrench-local-acceptability\synthetic-context-m3-reduction-02.json
  ```
