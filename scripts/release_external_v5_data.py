...
def main():
    challenge = write_dataset('independent-challenge-v5', 'data/pilots/independent-challenge-v5', 3)
    sealed = write_dataset('release-authoring-v5', 'data/pilots/release-authoring-v5', 20)
