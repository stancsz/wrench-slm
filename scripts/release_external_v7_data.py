...
def main():
    challenge = write_dataset('independent-challenge-v7', 'data/pilots/independent-challenge-v7', 3)
    sealed = write_dataset('release-authoring-v7', 'data/pilots/release-authoring-v7', 20)
